...
LineOffs:=0;//\|/ - тут (внизу) тоже был 0
for tmpJ:=tmpI+1 to Item-1 do LineOffs:=LineOffs+Length(myGetItemText(rv,tmpJ));
//
...
Procedure RememberCursorPos();
var StartItem,EndItem,I,ImCurIt,ImCurOf:integer;
itmText:string;
begin
...
ImCurOf,StartItem,EndItem,xLineNo,xLineOffs);

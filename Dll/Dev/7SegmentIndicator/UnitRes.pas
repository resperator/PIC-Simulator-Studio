    ...
    20: // gbColor
     ...
     begin
        case Lang of
          ...
          1:
            result := 'Уровень сигнала свечения сегмента';
        end;
        exit;
      end;
     ...
     begin
        case Lang of
          ...
          1:
            result := 'Инерционность изображения';
        end;
        exit;
      end;
     ...
     begin
        case Lang of
          ...
          1:
            result := 'Уровень на EN для свечения';
        end;
        exit;
      end;
         25: // rbAlwaysOn
